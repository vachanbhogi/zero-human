...
import { CTA, DISCOUNT, LIST_LABEL, PRICE_LABEL, TAGLINE } from "@/lib/brand";
        ...
        <div className="max-w-205 pb-10 pt-16 md:pb-14 md:pt-22">
          ...
          <div className="animate-fade-up-delay mt-6 flex flex-col gap-5 sm:mt-7 sm:flex-row sm:items-center sm:justify-between sm:gap-8">
            <p className="max-w-105 text-[15px] leading-6 text-[#8a8f98] md:text-[16px] md:leading-7">
              Tack is a {LIST_LABEL} agent-run growth desk. Founding rate{" "}
              {PRICE_LABEL} — {DISCOUNT} — if you start today. Paste a URL,
              get the campaign in about 3 minutes.
            </p>

            <div className="flex shrink-0 flex-wrap items-center gap-3 self-start sm:self-auto">
              <PayCta className="inline-flex items-center gap-2 rounded-lg bg-white px-4 py-2.5 text-[14px] font-medium text-[#08090a] transition-[opacity,transform] duration-150 ease-[cubic-bezier(0.23,1,0.32,1)] hover:opacity-90 active:scale-[0.97]">
                {CTA}
